...
class NamesControllerTest < ActionController::TestCase
  ...
  test "should create name" do
    assert_difference('Name.count') do
      post :create, name: { advertiser_id: @name.advertiser_id, category_id: @name.category_id, influencer_id: @name.influencer_id }
    end
  ...
  test "should update name" do
    patch :update, id: @name, name: { advertiser_id: @name.advertiser_id, category_id: @name.category_id, influencer_id: @name.influencer_id }
    assert_redirected_to name_path(assigns(:name))
  end
